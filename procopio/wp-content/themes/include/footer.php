          ...
          <div class="col-lg-4 offset-lg-1">
            <div class="appointMent_info">
              <div class="single_appontment">
                ...
                <p><?php echo esc_html(get_option("contact_address")); ?></p>
              </div>
              <div class="single_appontment">
                <h4>Envie-nos uma mensagem</h4>
                <p>
                  <a href="<?php echo get_option("contact_email"); ?>">
                    <?php echo esc_html(get_option("contact_email")); ?>
                  </a>
                  <br> +55 <?php echo esc_html(get_option("contact_phone")); ?>
                </p>
              </div>
              <div class="single_appontment">
                ...
                <p class="d-flex justify-content-between">
                  ...
                  <span><?php echo esc_html(get_option("contact_opening_hour_week")); ?></span>
                </p>
                <p class="d-flex justify-content-between">
                  <span>Sábados</span>
                  <span><?php echo esc_html(get_option("contact_opening_hour_weekend")); ?></span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xl-2  col-md-4 col-lg-2">
              <div class="footer_widget">
                ...
                <?php wp_nav_menu(get_menu_args("social_menu")); ?>
              </div>
            </div>   
          </div>
        </div>
              ...
              <p class="copy_right text-center">
                ...
                <p>
                  ...
                  <script>
                    ...
                    Procopio Engenharia. Todos os direitos reservados | Esse site foi desenvolvido by <a href="https://includejr.com.br" target="_blank">Include Jr</a>
                </p>
              </p>
            </div>
          </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        $('#calculadoraModal input[name="valor"]').maskMoney({
          prefix:'R$ ',
          allowNegative: false,
          thousands:'.',
          decimal:',',
        ...
        $('#modal2').click(function() {
          ...
          var valor_real_energia = $('[name="valor"]').maskMoney('unmasked')[0];
          var qnt_sol_pico;
        ...
        function buscaCidades(estado) {
          ...
          for(var x=0;x<num_estados;x++){
            if(json_cidades.estados[x].sigla == estado){
              j_index = x;
            }
          }
