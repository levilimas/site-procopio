...
jQuery(document).ready(function(o){["#menu-menu-principal-topo li a","#menu-menu-principal-topo-1 li a","#menu-menu-secundario-rodape li a"].map(function(e){o(e).map(function(){var e=o(this).attr("title");o(this).attr("title",e.substr(0,e.indexOf(".")))})}),o(".mob-header .mob-menu .open-menu").click(function(){o("#mob-header-sidemenu").css("right","0%")}),o("#mob-header-sidemenu .close-menu").click(function(){o("#mob-header-sidemenu").css("right","100%")}),o(".mob-header .mob-search a").click(function(){"open-search"==o(this).attr("class")?(o("#mob-header-bottomsearch").css("bottom","0"),o(this).attr("class","close-search"),o(this).children().attr("class","fas fa-times")):(o("#mob-header-bottomsearch").css("bottom","-11%"),o(this).attr("class","open-search"),o(this).children().attr("class","fas fa-search"))}),o(".social-header-notices .owl-carousel").owlCarousel({items:1,loop:!0,dots:!1,autoplay:!0,autoplayTimeout:5e3,autoplayHoverPause:!0}),o(".owl-carousel.banners-promo").owlCarousel({items:1,loop:!0,dots:!1,autoplay:!0,autoplayTimeout:6e3,autoplayHoverPause:!0}),o(".side-promo .owl-carousel").owlCarousel({items:1,loop:!0,dots:!1,autoplay:!0,autoplayTimeout:6e3,autoplayHoverPause:!0}),o(".eventos .owl-carousel").owlCarousel({items:4,loop:!0,dots:!0,margin:10,stagePadding:30,autoplay:!0,autoplayTimeout:3e3,autoplayHoverPause:!0,responsive:{0:{items:1},353:{items:2},425:{items:3},768:{items:2},992:{items:4}}})});