...
<div class="wrap">
	...
	<form method="post" action="options.php" enctype="multipart/form-data">
		...
		<h2 class="nav-tab-wrapper">
			...
			<a href="?page=theme-config&tab=contact_options" class="nav-tab <?php echo $active_tab == 'contact_options' ? 'nav-tab-active' : ''; ?>">Contato</a>
		...
		<?php 
			...
			($active_tab !== 'about_options') ? submit_button() : ''; 
		?>
	</form>
</div>