   <!-- footer_start  -->
    <footer class="footer">
        <div class="footer_top">
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-md-9 col-lg-4 ">
                    ...
                    <div class="col-xl-12">
                        <p class="copy_right text-center">
                            ...
                            <p>
                                ...
                                </script> Procopio Engenharia. Todos os direitos reservados | Esse site foi desenvolvido by <a href="https://includejr.com.br" target="_blank">Include Jr</a>
                            </p>
                        </p>
                    </div>
                </div>
    ...
    <!-- JS here -->
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/vendor/modernizr-3.5.0.min.js"></script>
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/popper.min.js"></script>
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/bootstrap.min.js"></script>
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/owl.carousel.min.js"></script>
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/isotope.pkgd.min.js"></script>
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/ajax-form.js"></script>
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/waypoints.min.js"></script>
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/jquery.counterup.min.js"></script>
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/imagesloaded.pkgd.min.js"></script>
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/scrollIt.js"></script>
    <script src="<?php echo home_url(); ?>/wp-content/themes/site-procopio/js/jquery.scrollUp.min.js"></script>
      ...
      "cidades": [
        ...
        function buscaCidades(e){
           ...
           if(j_index != -1){
            ...
            $('#cidade').val(1).niceSelect('update');
        }
        ...
        $(document).ready(function() {
            ...
            $(".slicknav_menu a").click(function(event) {
                var visivel = $('.slicknav_open').is(':visible');
                if(visivel){
                    $('body').click(function(e){    
                        if(e.target.id == "sticky-header")
                              return;
                        //Essa condição verifica se o clique foi feito em algum elemento dentro da sua div. Esse tem '#' porque é um seletor do jquery
                        if($(e.target).closest('#sticky-header').length)
                              return;  
